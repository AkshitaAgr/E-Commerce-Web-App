...
VALUES
  ...
  ('p145', 'Organic Milk (2%)', 2.99, 'Dairy Delights', 2),
  ('p146', 'Organic Milk (2%)', 3.29, 'MooMoo Farms', 2),
  ('p147', 'Organic Milk (2%)', 2.79, 'Farm Fresh Dairy', 2),
  ('p148', 'Organic Milk (2%)', 3.09, 'Healthy Harvest Store', 2),
  ('p149', 'Organic Milk (2%)', 2.92, 'Dairy Haven', 2),
  ('p150', 'Organic Milk (2%)', 3.18, 'Local Dairy Delights', 2),
  ...
  ('p181', 'Ground Beef (80% Lean)', 3.99, 'MeatWorld', 3),
  ('p182', 'Ground Beef (80% Lean)', 4.29, 'Meat Master', 3),
  ('p183', 'Ground Beef (80% Lean)', 3.79, 'Seafood & More', 3),
  ('p184', 'Ground Beef (80% Lean)', 4.09, 'Protein Paradise', 3),
  ('p185', 'Ground Beef (80% Lean)', 3.89, 'Meat Market', 3),
  ('p186', 'Ground Beef (80% Lean)', 4.19, 'Local Butcher', 3),
